...
const Signup = () => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user) {
        // Create the user profile without a role - role will be selected in onboarding
        ...
        toast({
          ...
          description: "Welcome to Rheo! Let's set up your account.",
        });
        navigate("/onboarding");
      }
    } catch (error: any) {
  ...
  return (
    <AuthLayout
      ...
      subtitle="Join Rheo and start your journey"
    >
