...
const ParticipantSignup = () => {
    ...
    try {
      ...
      if (data.user) {
        ...
        toast({
          ...
          description: "Welcome to Rheo! Start exploring events and register for your favorites.",
        });
  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      const { error } = await supabase.auth.signInWithOAuth({
        provider: 'google',
        options: {
          redirectTo: `${window.location.origin}/participant/dashboard`,
          queryParams: {
            access_type: 'offline',
            prompt: 'consent',
          },
  ...
  return (
    <AuthLayout
      ...
      subtitle="Explore events and register for your favorites"
      userType="community"
    >
